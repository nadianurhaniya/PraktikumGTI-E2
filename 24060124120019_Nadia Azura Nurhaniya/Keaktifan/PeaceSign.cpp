...
// NIM  : 24060124120019
// Deskripsi : Emoji berbentuk Peace Sign 
#include <GL/glut.h>

static int shoulder = 0, elbow = 45, wrist = 0;
static int thumb1 = 240, thumb2 = 10, thumb3 = 0;
static int index1 = 0, index2 = 0, index3 = 0;
static int middle1 = 0, middle2 = 0, middle3 = 0;
static int ring1 = 70, ring2 = 70, ring3 = 70;
static int little1 = 80, little2 = 80, little3 = 80;
...
void display(void){
    ...
    glPushMatrix();
        ...
        glRotatef(10 + (GLfloat)index1,0.0,0.0,1.0);
    ...
    glPushMatrix();
        ...
        glRotatef(-10 + (GLfloat)middle1,0.0,0.0,1.0);
